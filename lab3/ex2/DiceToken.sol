...
contract DiceToken {
    ...
    */
    ...
    function checkCreditAddress(address add) public view returns (uint256) {
        return erc20Contract.balanceOf(add);
    }

    function transferDt(address _to, uint256 _val) public {
        erc20Contract.transfer(_to, _val);
    }
